...
namespace URNG
{
    public class UniqueSequenceGenerator
    {
        ...
        public static List<uint> Sequence(int seed ,uint size)
        {
        ...
        /// <returns></returns>
        public static List<uint> Sequence(int seed ,uint size, uint max)
        {
            random = new LinearCongruentialGenerator(seed , max);
        ...
        /// <returns></returns>
        public static List<int> Sequence(int seed , uint size, int min, int max)
        {
            random = new LinearCongruentialGenerator(seed , min, max);
